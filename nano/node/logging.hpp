...
public:
	...
	bool network_timeout_logging_value{ true };
	bool network_message_logging_value{ true };
	bool network_publish_logging_value{ true };
	bool network_packet_logging_value{ true };
	bool network_keepalive_logging_value{ true };
	bool network_node_id_handshake_logging_value{ true };
	bool network_telemetry_logging_value{ true };
	bool network_rejected_logging_value{ true };
